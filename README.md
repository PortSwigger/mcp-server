...
1. **Java**: Java must be installed and available in your system's PATH. You can verify this by running `java --version`(`java -version` on older versions of java) in your terminal.
